            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form method="POST">
                    ...
                    <tr>
                      ...
                      if (isset($_POST['rechercher'])) {
                        ...
                        if (empty($mot)) {
                          ...
                          $sql = "SELECT * FROM $table where nom LIKE '%$mot%' OR (`type_salles` LIKE '%$mot%')  OR (`type_event` LIKE '%$mot%') AND `statut` = 'Entrante'";
                  ...
                  <div class="col-md-3">
                    <div class="row">
                      <form action="client_approve_db.php"><button id="approve" class="pull-right">Vérifier la
                          résérvation</button>
                      </form>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="row">
                      <p><a class="btn btn-danger"
                          href="../projet_fin/admin_delete_client.php?reservation_id=<?php echo $ligne->reservation_id; ?>"
                          id="cancel" class="pull-left">SUPPRIMER</a> </p>
                    </div>
                  </div>
                  </div>
