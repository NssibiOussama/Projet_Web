        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="../projet_fin/admin_page.php" class="list-group-item active main-color-bg">
                                    ...
                                    <input name="nom" class="form-control" required>           
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
										...
										<div>
										<div>
									<h4 style="color: green ;" >	REMARQUE </h2>
										  <div class="panel-heading">

                          Chaque réservation comprend automatiquement
    ...
    echo"</select>" ;
        ?>
                ...
                <div class="form-group">
                                            ...
                                            <input name="date_debut" type ="date" class="form-control" placeholder="yyyy-mm-dd" required="">        
                               </div>
                 <div class="form-group">
                                            <label>DATE FIN</label>
                                            <input name="date_fin" type ="date" class="form-control" placeholder="yyyy-mm-dd" required=""><br><br>
