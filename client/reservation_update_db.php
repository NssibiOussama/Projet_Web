...
nom= $nom,
email= $email , telephone =$telephone, type_salles=$type_salles, type_event=$type_event,date_debut=$date_debut,date_fin=$date_fin
...
" . $bdd->errorInfo()[2] . "</p>");
	...
	$msg = 'Mise a jour avec succcéés !';
	header('Location: ma_compte.php?msg=' . $msg . '');
	?>
