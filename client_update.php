          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="../projet_fin/client_home.php" class="list-group-item"><span class="fa fa-home" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;ACCEUIL</li></a>
               <a href="../projet_fin/client.php" class="list-group-item" style="background-color: #f4f4f4;"><span class="fa fa-credit-card" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Reservation</li></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 "><br>
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                          <form name="form" action="../projet_fin/reservation_update_db.php" method="post">
						  ...
						  <div class="form-group">
                                          <label>ID</label>
                                          <input name="reservation_id" type ="text" class="form-control" value="<?=$ligne->reservation_id; ?>" readonly required>                    
                                        </div> 
                                  <div class="form-group">
                                          <label>Email</label>
                                          <input name="email" type ="text" class="form-control" value="<?=$ligne->email; ?>" required>                    
                                        </div>            
                                      <div class="form-group">
                                          <label>TELEPHONE</label>
                                          <input name="telephone" type ="text" class="form-control" value="<?=$ligne->telephone; ?>" required>                    
                                        </div> 
    ...
    echo"</select>" ;
        ?>
                ...
                <div class="form-group">
                                            ...
                                            <input name="date_debut" type ="date" class="form-control" placeholder="yyyy-mm-dd" value="<?=$ligne->date_debut; ?>"  required="">        
                               </div>
                 <div class="form-group">
                                            <label>DATE FIN</label>
                                            <input name="date_fin" type ="date" class="form-control" placeholder="yyyy-mm-dd" value="<?=$ligne->date_fin; ?>"  required=""><br><br>
								...
								<a href="../projet_fin/ma_compte.php"><button type="button" class="btn btn-danger">Cancel</button> </a>
                               </div>
              </div>
                       </div>
                </div>
